...
<div class="info-card">
  ...
  <div class="info-card-body">
    ...
    Each month, <b>6 lucky winners</b> are chosen through a draw verifiable on-chain. Hey! That lucky one can be you! Ticket price is kept at a price which you pay for a single bank transaction. Good news is, you pay taxes according to your own regions and can participate in it from anywhere in the world. 
    <b>How about starting with just $2 and join in with us on this amazing experience. We are about to make a day, a week, a year or lifetime of our lucky winners!</b>   </div>
</div>""",
            unsafe_allow_html=True,
        )
    with c2:
